...
2. Create `github-pages-skill.config.json` in the root (see setup below)
...
Create `github-pages-skill.config.json` in the repo root:
...
1. Reads `github-pages-skill.config.json` for PAT + repo info
2. Asks for:
